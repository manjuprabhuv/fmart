 ...
 * 
 * @see com.fmart.hibernate.pojos.Company
...
public class CompanyDao {
	...
	public void update(Company transientInstance, Integer id) {
		log.debug("persisting Company instance");
		Transaction tx = null;
		Session session = HibernateUtil.getSession();
		try {
			...
			NotificationUtils.saveNotification(fromVal, toVal, Company.class,
	...
	public List<Company> findAll() {
		...
		try {
			...
			String queryString = "from " + Company.class.getCanonicalName();
			Query queryObject = session.createQuery(queryString);
			List<Company> genericList = queryObject.list();
			return genericList;
		} catch (RuntimeException re) {
	...
	public <T> List<Company> findByCriteria(Map<String, String> properties) {
		Session session = HibernateUtil.getSession();
		try {
			...
			Criteria cr = session
					...
					.setResultTransformer(
							Transformers.aliasToBean(Company.class));
