...
/**
 * Dao object for domain model class ExpenseType.
 * 
 * @see com.fmart.hibernate.pojos.ExpenseType
...
public class ExpenseTypeDao {
	...
	public void save(ExpenseType transientInstance) {
		log.debug("persisting ExpenseType instance");
		Transaction tx = null;
	...
	public void update(ExpenseType transientInstance, Integer id) {
		log.debug("persisting ExpenseType instance");
		Transaction tx = null;
		Session session = HibernateUtil.getSession();
		try {
			...
			NotificationUtils.saveNotification(fromVal, toVal,
					ExpenseType.class, username, NotificationType.UPDATE);
	...
	public ExpenseType findById(int id) {
		...
		Session session = HibernateUtil.getSession();
		try {
			ExpenseType instance = (ExpenseType) session.get(ExpenseType.class,
					id);
	...
	public List<ExpenseType> findAll() {
		...
		try {
			...
			String queryString = "from " + ExpenseType.class.getCanonicalName();
			Query queryObject = session.createQuery(queryString);
			List<ExpenseType> genericList = queryObject.list();
			return genericList;
		} catch (RuntimeException re) {
	...
	public <T> List<ExpenseType> findByCriteria(Map<String, String> properties) {
		Session session = HibernateUtil.getSession();
		try {
			...
			Criteria cr = session
					.createCriteria(ExpenseType.class)
					.setProjection(projections)
					.setResultTransformer(
							Transformers.aliasToBean(ExpenseType.class));
